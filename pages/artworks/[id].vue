<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white mt-10 to-gray-50">
    <!-- Loading State -->
    ...
    <div v-else-if="!product" class="container mx-auto px-6 py-32 text-center">
      <div class="max-w-md mx-auto">
        ...
        <NuxtLink to="/artworks" class="inline-flex items-center px-8 py-3 bg-gray-900 text-white rounded-full hover:bg-gray-800 transition-all duration-300 hover:scale-105 shadow-lg">
    ...
    <div v-else class="container mx-auto px-6 py-12">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div class="relative animate-slide-in-left">
          ...
          <div class="relative group">
            <div class="aspect-square overflow-hidden rounded-2xl bg-white shadow-xl hover:shadow-2xl transition-all duration-500">
              ...
              <div class="absolute top-4 left-4 flex flex-col gap-2">
                <div v-if="product.isNew" class="bg-gradient-to-r from-amber-400 to-orange-400 text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg">
                  ✨ New
                </div>
                <div v-if="product.isBestseller" class="bg-gradient-to-r from-rose-500 to-pink-500 text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg">
                  🔥 Best Seller
                </div>
                <div v-if="product.isFeatured" class="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg">
                  ⭐ Featured
                </div>
              </div>
          ...
          <div v-if="product.images.length > 1" class="mt-6 animate-fade-in-up animation-delay-300">
            <div class="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
              ...
              >
                <img :src="image" :alt="`${product.name} view ${index + 1}`" class="w-full h-full" />
              </button>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-col animate-slide-in-right">
            ...
            <div class="flex items-center">
              <div class="flex text-amber-400 mr-2">
                <svg 
                  ...
                  :class="i <= (averageRating || 5) ? 'fill-amber-400' : 'text-gray-300'"
                >
          ...
          <div class="mb-6 bg-gradient-to-r from-white to-gray-50 p-4 rounded-xl shadow-md animate-fade-in-up animation-delay-300">
            <div class="flex items-baseline gap-3 mb-2">
              <span class="text-3xl font-light text-gray-900">
                ...
                <span v-else>{{ convertFromUSD(currentPrice)?.formattedAmount }}</span>
              </span>
          ...
          <!-- Size Selection with Installment Options -->
              ...
              >
                <div class="flex justify-between items-center">
                  <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-500 mb-1">{{ getSizeDescription(size.size) }}</p>
                    <!-- Installment Option Display -->
                    <div v-if="hasInstallmentOption(size)" class="text-xs text-blue-600 font-medium">
                      ...
                      <div class="flex items-center gap-2 mt-1">
                        <div class="flex text-amber-400">
                          <svg 
                            ...
                            stroke-linecap="round" 
                            stroke-linejoin="round" 
                            :class="i <= reviewItem.rating ? 'fill-amber-400' : 'text-gray-300'"
                          >
                            <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
                          </svg>
                        </div>
      ...
      >
        ...
        >
          ...
          <img 
            :src="product.images[activeImageIndex]"
            :alt="product.name"
            class="max-w-[90vw] max-h-[90vh] rounded-xl shadow-2xl transition-all duration-500"
          />
          <!-- Image Navigation -->
...
const getInstallmentPayment = (size: any) => {
...
const { fetchingProductReview, review } = useFetchReview()
