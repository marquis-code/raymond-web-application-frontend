<template>
    <div class="min-h-screen bg-black text-white">
      ...
      <section id="courses" class="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div class="max-w-7xl mx-auto">
          ...
          <!-- Featured Courses -->
          <div v-if="activeCategory === 0" class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <div class="p-6">
                  ...
                  <p class="text-gray-400 text-sm mb-4">A course by {{ course.instructor }}</p>
                  ...
                  <div class="flex items-center mb-4">
                    ...
                    <span class="text-white text-sm">{{ course.rating }}% ({{ course.reviewCount }})</span>
                  </div>
          ...
          <div>
            ...
            <div v-if="filteredCourses.length === 0" class="text-center py-20">
              <p class="text-xl text-gray-400">No courses found in this category.</p>
            </div>
              ...
              >
                <div class="relative">
                  <img 
                    ...
                    @error="handleImageError"
                  />
                  <div v-if="course.isBestSeller" class="absolute top-4 left-4">
                    <span class="inline-block px-3 py-1 bg-amber-500 text-black text-xs font-bold rounded-full">
                      BEST SELLER
                    </span>
                  </div>
      ...
      <section class="py-20 px-4 sm:px-6 lg:px-8 bg-black">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-white mb-4">What Our Students Say</h2>
            <p class="text-gray-400 max-w-2xl mx-auto">
              Join thousands of artists who have transformed their skills and careers through our courses.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div 
              ...
              :key="index"
              class="bg-gray-900 p-6 rounded-xl shadow-lg transform transition-all duration-500 hover:shadow-rose-500/10 hover:shadow-xl"
            >
              <div class="flex items-center mb-4">
              ...
              <p class="mt-4 text-rose-400 text-sm">
                {{ testimonial.course }}
              </p>
            </div>
          </div>
  ...
  const courses = ref([
    ...
    },
    {
      ...
      description: 'Master the principles of color theory and elevate your artwork with harmonious color palettes.',
      imageUrl:  artwork2,
      rating: 94,
      reviewCount: '356',
      regularPrice: 49.99,
    ...
    },
    {
      ...
      description: 'Start your watercolor journey with essential techniques and create beautiful paintings from day one.',
      imageUrl:  artwork2,
      rating: 93,
      reviewCount: '378',
      regularPrice: 49.99,
    ...
    {
      id: 9,
      title: 'Digital Illustration for Social Media',
      instructor: 'Sophia Lee',
      description: 'Create eye-catching digital illustrations optimized for social media platforms and grow your online presence.',
      imageUrl:  artwork1,
      rating: 96,
      reviewCount: '423',
      regularPrice: 49.99,
  ...
  const featuredCourses = computed(() => {
    return courses.value.filter(course => course.isBestSeller).slice(0, 3)
  })
