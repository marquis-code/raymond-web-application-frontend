      ...
      <div class="banner-container">
        <div class="content-overlay">
          <div class="text-content">
            ...
            <button class="text-sm bg-white text-gray-900 px-6 py-3" @click="handleShopClick">
...
const handleShopClick = async() => {
  ...
  .banner-container {
    position: relative;
    width: 100%;
    min-width: 768px; /* Minimum width to maintain image size */
    min-height: 400px;
    display: flex;
    align-items: center;
  ...
  @media (max-width: 768px) {
    ...
    .banner-container {
      min-width: 768px; /* Keep container wide enough for image */
    }
    
    .banner-image {
      min-width: 768px; /* Prevent image shrinking */
    }
    
    .text-content {
      padding: 0 15px;
      /* Text remains centered within the scrollable area */
    }
  ...
  @media (max-width: 480px) {
    .promo-banner {
      /* Maintain horizontal scroll for very small screens */
      overflow-x: auto;
      overflow-y: hidden;
    ...
    .banner-container {
      min-width: 768px; /* Keep container wide */
    }
