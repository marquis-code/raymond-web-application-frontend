<template>
    <Teleport to="body">
      ...
      >
        ...
        <!-- Modal Container -->
        <div 
          class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl transform transition-all duration-300 mx-auto"
        ...
        >
          ...
          <div class="lg:p-6 p-3">
            ...
            <div class="text-center mb-6">
              ...
              <p class="text-gray-600 text-smm">How would you like to pay for your selected items?</p>
            </div>
            ...
            <div class="space-y-4 mb-6">
              ...
              <div v-if="!hasInstallmentOption" class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div class="flex items-center">
                  ...
                  <span class="text-sm text-yellow-800">Installment payment is not available for this item</span>
                </div>
              </div>
            </div>
...
// })
  ...
  const hasInstallmentOption = computed(() => {
    return props.cartItem?.hasInstallmentOption === true && 
           props.cartItem?.installmentConfig?.enabled === true
  })
  ...
  const getMinimumInstallmentAmount = () => {
    ...
    const maxTerms = Math.max(...(props.cartItem.installmentConfig.availableTerms || [12]))
    const minDownPaymentPercentage = props.cartItem.installmentConfig.minimumDownPaymentPercentage || 20
