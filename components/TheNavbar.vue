<template>
    <div>
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
              ...
              >
                ...
                <span v-if="cartCount > 0" class="absolute -top-1 -right-1 bg-black text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                  {{ cartCount }}
                </span>
              </button>
              ...
              >
                <!-- <Icon v-if="!isMobileMenuOpen" name="lucide:menu" size="24" /> -->
      ...
      <div 
        class="fixed top-0 right-0 bottom-0 w-full md:w-96 bg-white z-50 shadow-xl transform transition-transform duration-300 ease-in-out"
